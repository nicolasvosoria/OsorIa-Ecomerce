...
// Cruzar el puntero por encima camino del contenido no debe desplegar la barra.
const SIDEBAR_PEEK_DELAY_MS = 200
...
function SidebarProvider({
  ...
  const toggleSidebar = React.useCallback(() => {
    ...
    setPinned(!pinned)
  }, [isMobile, openMobile, pinned, setPinned])

  // El atajo escucha en `window`, así que opera sobre el pin aunque el puntero
  // esté sobre la barra en pleno peek.
  React.useEffect(() => {
  ...
  const state = pinned || peeking ? "expanded" : "collapsed"
...
function Sidebar({
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Muestra la barra lateral de navegación.</SheetDescription>
          </SheetHeader>
  ...
  return (
    <div
      ...
      data-side={side}
      data-slot="sidebar"
      onMouseEnter={startPeekCountdown}
      onMouseLeave={stopPeeking}
    >
      {/* El hueco reserva el espacio que empuja al contenido, así que mira solo
          al pin: durante el peek la barra se despliega por encima, sin empujar. */}
      <div
