        ...
        <div className="order-1 min-w-0 flex-1 md:order-2">
          ...
          >
            ...
            {discountPercentage && discountPercentage > 0 && (
              <div className="absolute left-4 top-4 z-10 rounded-full bg-destructive px-3 py-1 text-sm font-semibold text-destructive-foreground">
                -{discountPercentage}%
              </div>
            )}
            ...
            {hasMultipleImages && (
              <>
                <Button
                  ...
                  variant="secondary"
                  size="icon"
                  className="absolute left-4 top-1/2 z-10 h-10 w-10 -translate-y-1/2 rounded-full opacity-100 shadow-lg transition-opacity md:opacity-0 md:group-hover:opacity-100"
                ...
                <Button
                  ...
                  variant="secondary"
                  size="icon"
                  className="absolute right-4 top-1/2 z-10 h-10 w-10 -translate-y-1/2 rounded-full opacity-100 shadow-lg transition-opacity md:opacity-0 md:group-hover:opacity-100"
